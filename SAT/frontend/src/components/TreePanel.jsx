      ...
      >
        ...
        {!isFullscreen && (
          <div className="mt-4 rounded-xl border border-blue-100 bg-blue-50 p-3 text-base text-[#6B7280] transition-all duration-300 dark:border-[#263042] dark:bg-[#151B2D] dark:text-[#D1D5DB]">
            ...
            <span className="hidden sm:inline">Tip: Scroll normally to move the page. Drag to pan the tree, use Ctrl/⌘ + wheel or +/− to zoom, and click a terminal node to highlight its word.</span>
          </div>
        )}
