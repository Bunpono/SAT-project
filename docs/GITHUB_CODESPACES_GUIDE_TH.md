...
หาก dependency ยังติดตั้งไม่ครบ สคริปต์จะเรียก setup ให้อัตโนมัติก่อนเริ่มระบบ การรันครั้งแรกจึงอาจใช้เวลานานกว่าครั้งถัดไป
...
เมื่อผู้ใช้เปิดลิงก์ครั้งแรก GitHub จะแสดงคำเตือนว่าเป็น development port ให้กด **Continue** เฉพาะเมื่อได้รับลิงก์จากผู้ดูแลโครงการที่เชื่อถือได้ คำเตือนนี้จะแสดงหนึ่งครั้งต่อ Codespace session
